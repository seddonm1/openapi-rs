...
impl Message {
    pub fn new(body: String, created_at: String, id: String, recipient: String, send_count: i64, status: models::CourierMessageStatus, subject: String, template_type: TemplateType, r#type: models::CourierMessageType, updated_at: String) -> Message {
        Message {
            body,
            channel: None,
            created_at,
